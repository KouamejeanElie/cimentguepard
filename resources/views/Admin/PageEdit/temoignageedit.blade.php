...
<head>
    ...
    <title>MMAS - Modifier un Témoignages</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-list-alt"></i>&nbsp;Modifier le Témoignage #{{ $temoignage->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updatetemoignage', $temoignage->id )}}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Nom</label>
                                                <input type="text" value="{{ $temoignage->nom }}" name="nom" class="form-control @error('nom') is-invalid @enderror" placeholder="Entrer le nom...">
                                                @error('nom')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $temoignage->provenance }}" name="provenance" class="form-control @error('provenance') is-invalid @enderror">
                                            @error('provenance')
                                             <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                             </span>
