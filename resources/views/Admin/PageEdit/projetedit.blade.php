...
<head>
    ...
    <title>MMAS - Modifier un projet</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-list-alt"></i>&nbsp;Modifier le Projet #{{ $projet->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updateprojet', $projet->id )}}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Titre du projet</label>
                                                <input type="text" value="{{ $projet->titre }}" name="titre" class="form-control @error('titre') is-invalid @enderror" placeholder="Entrer le titre du projet">
                                                @error('titre')
                                           ...
                                           <div class="form-group col-md-6">
                                            ...
                                            <img src="{{ asset('uploads/projet/'. $projet->image)}}">
                                            </div>
                                        </div><br /><br />
