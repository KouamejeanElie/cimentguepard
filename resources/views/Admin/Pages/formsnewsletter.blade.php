            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                 <p class="alert alert-info">Liste des Newsletters</p>
                                <div class="active-member">
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                             @foreach($listeTotalNewsletters as $listeTotalNewsletter)
                                                <tr>
                                                    <td>{{ $listeTotalNewsletter->id }}</td>
                                                    <td>{{ $listeTotalNewsletter->emailnews }}</td>
                                                     <td>
                                                        <form method="POST" action="{{ route('path_delete_admin_newsletter',$listeTotalNewsletter->id)}}" onsubmit="return confirm('Etes vous sûre ?');">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
