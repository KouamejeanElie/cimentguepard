            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                 <p class="alert alert-info">Liste des Rdv Demandés</p>
                                            ...
                                            <tbody>
                                             @foreach($listeTotalRdvs as $listeTotalRdv)
                                                <tr>
                                                    ...
                                                    <td>{{ $listeTotalRdv->identite }}</td>
                                                    <td>{{ $listeTotalRdv->contact }}</td>
                                                    <td>{{ $listeTotalRdv->emailrdv }}
                                                    </td>
                                                    <td>{{ $listeTotalRdv->daterdv }}</td>
                                                    <td>{{ $listeTotalRdv->heurerdv }}</td>
                                                    <td>{{ $listeTotalRdv->service }}</td>
                                                    <td>{{ $listeTotalRdv->message }}</td>
                                                     <td>
